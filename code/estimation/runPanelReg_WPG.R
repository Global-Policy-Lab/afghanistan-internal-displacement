...
### this script: modified from _new.R --- for where people go
args = commandArgs(trailingOnly = TRUE) 
ddEvents <- readRDS(paste0("/data/tmp/xtai/districtDay_eventsOnly_8-11.rds")) 
...
outFileName0 <- paste0("/data/tmp/xtai/9-22wherePeopleGo/betaCoefList_sameProvincialCapComp.rds")
outFileName1 <- paste0("/data/tmp/xtai/9-22wherePeopleGo/betaCoefList_top5exclhomeComp_capitals.rds")
outFileName2 <- paste0("/data/tmp/xtai/9-22wherePeopleGo/betaCoefList_top5exclhomeComp_nonCap.rds")

outFileName3 <- paste0("/data/tmp/xtai/9-22wherePeopleGo/betaCoefList_remainingCapComp_capitals.rds")
outFileName4 <- paste0("/data/tmp/xtai/9-22wherePeopleGo/betaCoefList_remainingCapComp_nonCap.rds")

outFileName7 <- paste0("/data/tmp/xtai/9-22wherePeopleGo/betaCoefList_sameProvNonCapComp_capitals.rds")
outFileName8 <- paste0("/data/tmp/xtai/9-22wherePeopleGo/betaCoefList_sameProvNonCapComp_nonCap.rds")

outFileName9 <- paste0("/data/tmp/xtai/9-22wherePeopleGo/betaCoefList_otherProvNonCapComp_capitals.rds")
outFileName10 <- paste0("/data/tmp/xtai/9-22wherePeopleGo/betaCoefList_otherProvNonCapComp_nonCap.rds")
...
for (i in c(7, 30, 90)) {
  cat(i, ", ")
  ddOutcomesFull <- readRDS(paste0("/data/tmp/xtai/districtDayWPG/districtDayWPG_9-22_outcomeOnly_", i, "_comp12-11.rds"))
